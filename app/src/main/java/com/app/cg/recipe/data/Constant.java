...
import com.app.cg.recipe.model.Category;
...
public class Constant {
    ...
    public static List<Category> getItemCategory(Context ctx) {
        ...
        TypedArray img_cat = ctx.getResources().obtainTypedArray(R.array.category_photos); //taken from the string-data.xml
    ...
    public static List<Recipe> getItemFavorites(Context ctx){
        ...
        Set<String> set = Utils.getFavorites(ctx);
        List<String> items_id = new ArrayList<>(set.size());
        items_id.addAll(set);
